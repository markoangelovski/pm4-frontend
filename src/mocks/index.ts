// Types
import { Project, User, Task, Day, PmEvent, Log } from "@/types";
...
export const user: User = {
  ...
  modifiedAt: new Date("2023-11-10T10:45:00Z"),
...
export const projects: Project[] = [
  {
    ...
    modifiedAt: new Date("2023-11-10T15:20:00Z"),
  },
  {
    ...
    modifiedAt: new Date("2023-11-10T11:15:00Z"),
  },
  {
    ...
    modifiedAt: new Date("2023-11-09T18:00:00Z"),
  },
];
...
export const tasks: Task[] = [
  {
    ...
    modifiedAt: new Date("2023-11-03T13:15:00Z"),
    status: "done",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-02T14:20:00Z"),
      },
      {
        ...
        modifiedAt: new Date("2023-11-02T15:10:00Z"),
      },
    ],
  },
  {
    ...
    modifiedAt: new Date("2023-11-06T10:30:00Z"),
    status: "done",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-05T10:00:00Z"),
      },
      {
        ...
        modifiedAt: new Date("2023-11-06T09:30:00Z"),
      },
    ],
  },
  {
    ...
    modifiedAt: new Date("2023-11-08T12:30:00Z"),
    status: "in-progress",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-07T10:00:00Z"),
      },
      {
        ...
        modifiedAt: new Date("2023-11-08T11:45:00Z"),
      },
    ],
  },
  {
    ...
    modifiedAt: new Date("2023-11-07T17:30:00Z"),
    status: "upcoming",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-05T14:30:00Z"),
      },
      {
        ...
        modifiedAt: new Date("2023-11-07T17:00:00Z"),
      },
    ],
  },
  {
    ...
    modifiedAt: new Date("2023-11-03T18:30:00Z"),
    status: "in-progress",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-03T11:30:00Z"),
      },
      {
        ...
        modifiedAt: new Date("2023-11-03T16:00:00Z"),
      },
    ],
  },
  {
    ...
    modifiedAt: new Date("2023-11-04T15:20:00Z"),
    status: "in-progress",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-04T09:30:00Z"),
      },
      {
        ...
        createdAt: new Date("2023-11-04T14:00:00Z"),
        modifiedAt: new Date("2023-11-04T14:00:00Z"),
      },
    ],
  },
  {
    ...
    modifiedAt: new Date("2023-11-05T14:00:00Z"),
    status: "in-progress",
    ...
    notes: [
      {
        ...
        modifiedAt: new Date("2023-11-05T11:00:00Z"),
      },
      {
        ...
        modifiedAt: new Date("2023-11-05T13:30:00Z"),
      },
    ],
  },
];
...
export const days: Day[] = [
  {
    ...
    modifiedAt: new Date("2023-11-01T16:30:00Z"),
    startOfWork: 8,
    workedHours: 8,
    bookedHours: 6,
    externalBooking: 1,
    ...
    events: [
      {
        id: "event1",
        createdAt: new Date("2023-11-01T09:00:00Z"),
        modifiedAt: new Date("2023-11-01T11:00:00Z"),
        title: "Design App UI",
        workedHours: 2,
        bookedHours: 1.5,
        externalBooking: 0,
        ...
        logs: [
          {
            ...
            modifiedAt: new Date("2023-11-01T09:45:00Z"),
            eventId: "event1",
            title: "Started initial design drafts.",
            duration: 0.5,
          },
          {
            id: "event1-log2",
            ...
            modifiedAt: new Date("2023-11-01T11:00:00Z"),
            eventId: "event1",
            title: "Completed revisions based on feedback.",
            duration: 1,
          },
        ],
        bookings: [
          {
            ...
            modifiedAt: new Date("2023-11-01T10:30:00Z"),
            amount: 150,
      ...
      },
      {
        ...
        modifiedAt: new Date("2023-11-01T13:00:00Z"),
        title: "Implement App Backend",
        workedHours: 1,
        bookedHours: 1,
        externalBooking: 0,
        ...
        logs: [
          {
            ...
            modifiedAt: new Date("2023-11-01T12:45:00Z"),
            eventId: "event2",
            title: "Set up initial API routes.",
            duration: 0.5,
          },
          {
            id: "event2-log2",
            ...
            modifiedAt: new Date("2023-11-01T13:00:00Z"),
            eventId: "event2",
            title: "Tested API with mock data.",
            duration: 0.25,
          },
        ],
        bookings: [
          {
            ...
            modifiedAt: new Date("2023-11-01T12:30:00Z"),
            amount: 120,
            bookedDate: new Date("2023-11-01"),
          },
        ],
  ...
  },
  {
    ...
    modifiedAt: new Date("2023-11-02T16:30:00Z"),
    startOfWork: 8,
    workedHours: 7,
    bookedHours: 5.5,
    externalBooking: 1,
    ...
    events: [
      {
        ...
        modifiedAt: new Date("2023-11-02T10:30:00Z"),
        title: "Design Social Media Ads",
        workedHours: 1.5,
        bookedHours: 1,
        externalBooking: 0,
        ...
        logs: [
          {
            ...
            eventId: "event3",
            title: "Brainstormed design concepts.",
            duration: 0.5,
          },
        ],
        bookings: [
          {
            ...
            modifiedAt: new Date("2023-11-02T10:15:00Z"),
            amount: 90,
